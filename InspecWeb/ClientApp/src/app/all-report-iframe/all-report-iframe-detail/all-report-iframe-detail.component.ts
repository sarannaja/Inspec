...
@Component({
  selector: 'app-all-report-iframe-detail',
  templateUrl: './all-report-iframe-detail.component.html',
  styleUrls: ['./all-report-iframe-detail.component.css']
})
export class AllReportIframeDetailComponent implements OnInit {
