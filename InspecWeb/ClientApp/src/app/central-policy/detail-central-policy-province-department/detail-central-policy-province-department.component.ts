...
@Component({
  selector: 'app-detail-central-policy-province-department',
  templateUrl: './detail-central-policy-province-department.component.html',
  styleUrls: ['./detail-central-policy-province-department.component.css']
})
export class DetailCentralPolicyProvinceDepartmentComponent implements OnInit {
