...
export class RegisterDefaultLayoutTrainComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.Form = this.fb.group({
      ...
      positionbefore: new FormControl(""),
      department: new FormControl(null, [Validators.required]),
      departmentnew: new FormControl(null, [Validators.required]),
      phone: new FormControl(null, [Validators.required]),
      email: new FormControl(null, [Validators.required]),

      passportstatus: new FormControl(null, [Validators.required]),
      passportexpire: new FormControl(null),
      ...
      congenitaldisease: new FormControl(""),
      collaboratorposition: new FormControl(""),

      // type: new FormControl(null, [Validators.required]),
      type: new FormControl(null),
      nickname: new FormControl(null, [Validators.required]),
      // retireddate: new FormControl(null, [Validators.required]),
      retireddate: new FormControl(null),
