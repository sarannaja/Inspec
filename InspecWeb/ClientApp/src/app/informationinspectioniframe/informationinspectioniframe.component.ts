...
@Component({
  selector: 'app-informationinspectioniframe',
  templateUrl: './informationinspectioniframe.component.html',
  styleUrls: ['./informationinspectioniframe.component.css']
})
export class InformationinspectioniframeComponent implements OnInit {
  files: string[] = []
  data: any = []
  id:any;
  role_id:any;
