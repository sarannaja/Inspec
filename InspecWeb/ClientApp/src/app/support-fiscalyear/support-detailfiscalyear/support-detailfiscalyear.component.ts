...
@Component({
  selector: 'app-support-detailfiscalyear',
  templateUrl: './support-detailfiscalyear.component.html',
  styleUrls: ['./support-detailfiscalyear.component.css']
})
export class SupportDetailfiscalyearComponent implements OnInit {
