    ...
    public class TrainingController : Controller {
        ...
        public async Task<IActionResult> InsertTrainingRegister ([FromForm] TrainingRegisterViewModel model) {
            ...
            var trainingdata = new TrainingRegister {
                ...
                PositionBefore = model.PositionBefore,
                Department = model.department,
                Status = 0,
                PassportStatus = model.PassportStatus,
                PassportExpire = model.PassportExpire,
                ...
                Blood = model.Blood,
                CongenitalDisease = model.CongenitalDisease,
                CollaboratorPosition = model.CollaboratorPosition,
                UserId = model.userid,
                UserType = 1,
                Email = model.email,
                CreatedAt = date,
