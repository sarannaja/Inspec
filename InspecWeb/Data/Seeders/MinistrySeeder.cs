...
namespace InspecWeb.Data.Seeders
{
    public class MinistrySeeder : IEntityTypeConfiguration<Ministry>
    {
        ...
        {
            builder.HasData(
            new Ministry { Id = 1, Name = "สำนักนายกรัฐมนตรี", NameEN = "Office of the Prime Minister", ShortnameEN = "OPM" },
            ...
            new Ministry { Id = 7, Name = "กระทรวงเกษตรและสหกรณ์", NameEN = "Ministry of Agriculture and Cooperatives", ShortnameEN = "MOAC" },
            new Ministry { Id = 8, Name = "กระทรวงคมนาคม", NameEN = "Ministry of Transport", ShortnameEN = "MOT" },
            new Ministry { Id = 9, Name = "กระทรวงทรัพยากรธรรมชาติและสิ่งแวดล้อม", NameEN = "Ministry of Natural Resources and Environment", ShortnameEN = "MNRE" },
            ...
            new Ministry { Id = 12, Name = "กระทรวงพาณิชย์", NameEN = "Ministry of Commerce", ShortnameEN = "MOC" },
            new Ministry { Id = 13, Name = "กระทรวงมหาดไทย", NameEN = "Ministry of Interior", ShortnameEN = "MOI" },
