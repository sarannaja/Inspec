...
namespace QuickType
{
        ...
        public partial class Province
        {
                public static Province FromJson(string json) => JsonConvert.DeserializeObject<Province>(json, QuickType.Converter.Settings);
        }

        public static class Serialize
        {
                public static string ToJson(this Province self) => JsonConvert.SerializeObject(self, QuickType.Converter.Settings);
        }
